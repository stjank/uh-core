#include "list_objects_request.h"
...
namespace uh::cluster::rest::http::model
{
    ...
    list_objects_request& list_objects_request::operator = (const http::request_parser<http::empty_body>& recv_req)
    {
    ...
    std::map<std::string, std::string> list_objects_request::get_request_specific_headers() const
    {
