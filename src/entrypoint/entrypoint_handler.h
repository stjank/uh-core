...
namespace uh::cluster {
    ...
    coro < std::unique_ptr<rest::http::http_response> > handle_request (rest::http::http_request& req, rest::utils::server_state& state) {
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_create_bucket (const rest::http::http_request& req)
        {

            std::unique_ptr<rest::http::model::create_object_response> res = std::make_unique<rest::http::model::create_object_response>(req);
            ...
            try
            {
                ...
                co_await worker_utils::broadcast_from_io_thread_in_io_threads (m_directory_services.get_clients(), m_ioc, *m_workers, std::bind_front (func, std::cref (bucket_id)));
            }
            catch (const error_exception& e)
            {
                LOG_ERROR() << "Failed to add the bucket " << bucket_id << " to the directory: " << e;
                throw rest::http::model::custom_error_response_exception(boost::beast::http::status::not_found);
            }

            co_return std::move(res);
        }

        coro<std::unique_ptr<rest::http::http_response>> handle_delete_bucket (const rest::http::http_request& req)
        {
            ...
            try
            {
                res = std::make_unique<rest::http::model::delete_bucket_response>(req);

                auto func = [] (const rest::http::http_request& req, client::acquired_messenger m, long id) -> coro <void> {
                    directory_message dir_req;
                    dir_req.bucket_id = req.get_URI().get_bucket_id();
                    co_await m.get().send_directory_message (DIR_DELETE_BUCKET_REQ, dir_req);
                    co_await m.get().recv_header();
                };
                co_await worker_utils::broadcast_from_io_thread_in_io_threads (m_directory_services.get_clients(), m_ioc, *m_workers, std::bind_front(func, std::cref (req)));
            }
            catch (const error_exception& e)
            {
                ...
                switch (*e.error())
                {
                    ...
                    case error::bucket_not_empty:
                        throw rest::http::model::custom_error_response_exception(boost::beast::http::status::conflict, rest::http::model::error::bucket_not_empty);
                    default:
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_get_bucket (const rest::http::http_request& req)
        {

            std::unique_ptr<rest::http::model::get_bucket_response> res = std::make_unique <rest::http::model::get_bucket_response> (req);
            auto req_bucket_id = req.get_URI().get_bucket_id();

            try {

                auto func = [] (std::unique_ptr<rest::http::model::get_bucket_response>& res, const std::string& req_bucket_id, client::acquired_messenger m) -> coro <void> {
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_list_buckets (const rest::http::http_request& req)
        {

            std::unique_ptr<rest::http::model::list_buckets_response> res = std::make_unique <rest::http::model::list_buckets_response> (req);

            auto func = [] (std::unique_ptr<rest::http::model::list_buckets_response>& res, client::acquired_messenger m) -> coro <void> {
                co_await m.get().send(DIR_LIST_BUCKET_REQ, {});
                const auto h = co_await m.get().recv_header();
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_put_object (rest::http::http_request& req)
        {
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_get_object (const rest::http::http_request& req)
        {
            ...
            try
            {
                ...
                auto func = [] (std::string& buffer, const rest::http::http_request& req, client::acquired_messenger m) -> coro <void> {
                    directory_message dir_req;
                    dir_req.bucket_id = req.get_URI().get_bucket_id();
            ...
            catch (const error_exception& e)
            {
                ...
                switch (*e.error())
                {
                    case error::object_not_found:
                        throw rest::http::model::custom_error_response_exception(boost::beast::http::status::not_found, rest::http::model::error::object_not_found);
                    default:
                        throw rest::http::model::custom_error_response_exception(boost::beast::http::status::internal_server_error);
                }
            }
        ...
        std::unique_ptr<rest::http::http_response> handle_get_object_attributes (const rest::http::http_request& req)
        {

            std::unique_ptr<rest::http::model::get_object_attributes_response> res;

            res = std::make_unique<rest::http::model::get_object_attributes_response>(req);
            throw rest::http::model::custom_error_response_exception(boost::beast::http::status::not_implemented);

            return std::move(res);
        }


        coro<std::unique_ptr<rest::http::http_response>> handle_list_objects_v2 (const rest::http::http_request& req)
        {
            ...
            try
            {
                ...
                auto func = [] (std::unique_ptr<rest::http::model::list_objectsv2_response>& res, const rest::http::http_request& req, client::acquired_messenger m) -> coro <void> {
                    res = std::make_unique<rest::http::model::list_objectsv2_response>(req);
                    directory_message dir_req;
                    dir_req.bucket_id = req.get_URI().get_bucket_id();
        ...
        coro<std::unique_ptr<rest::http::http_response>> handle_list_objects (const rest::http::http_request& req)
        {
            std::unique_ptr<rest::http::model::list_objects_response> res;

            auto func = [] (std::unique_ptr<rest::http::model::list_objects_response>& res, const rest::http::http_request& req, client::acquired_messenger m) -> coro <void> {
                res = std::make_unique<rest::http::model::list_objects_response>(req);
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_init_mp_upload (const rest::http::http_request& req, rest::utils::server_state& state)
        {
            std::unique_ptr<rest::http::model::init_multi_part_upload_response> res;
            try
            {
                res = std::make_unique<rest::http::model::init_multi_part_upload_response>(req);
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_mp_upload (const rest::http::http_request& req, rest::utils::server_state& state) {
            if (req.get_body_size() > 0) [[likely]] {
                std::list <std::string_view> data {req.get_body()};
                const auto resp = co_await integrate_data(data);
                auto func = [](rest::utils::server_state& state, const rest::http::http_request& req, const auto& resp) {
        ...
        coro<std::unique_ptr<rest::http::http_response>> handle_complete_mp_upload (rest::http::http_request& req, rest::utils::server_state& state)
        {
            auto res = std::make_unique<rest::http::model::complete_multi_part_upload_response>(req);
        ...
        std::unique_ptr<rest::http::http_response> handle_abort_mp_upload (const rest::http::http_request& req)
        {
            std::unique_ptr<rest::http::model::abort_multi_part_upload_response> res = std::make_unique<rest::http::model::abort_multi_part_upload_response>(req);
            return std::move(res);
        }

        coro<std::unique_ptr<rest::http::http_response>> handle_delete_object (const rest::http::http_request& req)
        {

            std::unique_ptr<rest::http::model::delete_object_response> res = std::make_unique<rest::http::model::delete_object_response>(req);

            try
            {
                auto func = [] (const rest::http::http_request& req, client::acquired_messenger m) -> coro <void> {
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_list_mp_uploads (const rest::http::http_request& req, rest::utils::server_state& state)
        {

            std::unique_ptr<rest::http::model::list_multi_part_uploads_response> res = std::make_unique<rest::http::model::list_multi_part_uploads_response>(req);

            auto func = [] (std::unique_ptr<rest::http::model::list_multi_part_uploads_response>& res, rest::utils::server_state& state, const rest::http::http_request& req) {
        ...
        coro <std::unique_ptr<rest::http::http_response>> handle_delete_objects (rest::http::http_request& req)
        {
            ...
            auto func = [] (rest::http::http_request& req, pugi::xpath_node_set& object_nodes_set) {
                ...
                {
                    throw rest::http::model::custom_error_response_exception(boost::beast::http::status::bad_request, rest::http::model::error::type::malformed_xml);
                }
            };
            ...
            for (const auto& objectNode : object_nodes_set)
            {
                ...
                try
                {
                    ...
                    auto func2 = [] (const char* key, const std::string& bucket_id, std::unique_ptr<rest::http::model::delete_objects_response>& res, client::acquired_messenger m) -> coro <void> {
                        directory_message dir_req;
